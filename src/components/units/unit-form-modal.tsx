      ...
      <DialogContent className="max-h-[calc(100dvh-2rem)] overflow-hidden border-[var(--outline-variant)] bg-[var(--surface-container-lowest)] p-0 sm:max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="flex max-h-[calc(100dvh-10rem)] min-h-0 flex-col">
          <div className="min-h-0 flex-1 space-y-6 overflow-y-auto px-8 py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={category} onValueChange={setCategory}>
                  <SelectTrigger id="unitCategory" className="h-11 w-full border-[var(--outline-variant)] bg-white">
            ...
            <div className="pt-4 border-t border-[var(--outline-variant)]">
              <div className="bg-[var(--surface-container-low)] p-4 rounded-xl flex items-center justify-between border border-[var(--outline-variant)]">
                <div>
          ...
          <DialogFooter className="border-t border-[var(--outline-variant)] bg-[var(--surface-container-low)] px-8 py-6 flex justify-end gap-3">
            <Button
              type="button"
              variant="outline"
              onClick={() => onOpenChange(false)}
              className="h-11 border-[var(--outline-variant)] bg-white font-bold"
            >
              Cancel
            </Button>
            <Button
